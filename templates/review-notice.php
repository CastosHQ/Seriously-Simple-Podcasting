...
<div class="notice notice-info ssp-review-notice js-ssp-review-notice">
	<div class="ssp-review-notice__text">
		<p>
			<?php
			_e(
				'Hey, It seems you have been using Seriously Simple Podcasting for at least 7 days now -
			that\'s awesome!',
		...
		<p>
			<?php
			_e(
				'Could you please do us a BIG favor and give it a 5-star rating on WordPress?
			This will help us spread the word and boost our motivation - thanks!',
				'seriously-simple-podcasting'
			);
			?>
		</p>
