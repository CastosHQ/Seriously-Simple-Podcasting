...
var cover = document.querySelector('.player__artwork');
...
var volumeBtn = document.querySelector('.player-btn__volume');
var speedBtn = document.querySelector('.player-btn__speed');
...
var subscribePanel = document.querySelector('.player-panels .subscribe');
var subscribePanelClose = document.querySelector('.player-panels .subscribe .close-btn');
var shareBtn = document.querySelector('#share-btn');
var sharePanel = document.querySelector('.player-panels .share');
var sharePanelClose = document.querySelector('.player-panels .share .close-btn');
var linkCopyElm = document.querySelector('.input-link');
var linkCopyBtn = document.querySelector('.copy-link');
var embedCopyElm = document.querySelector('.input-embed');
var embedCopyBtn = document.querySelector('.copy-embed');
var rssCopyElm = document.querySelector('.input-rss');
var rssCopyBtn = document.querySelector('.copy-rss');
