...
<div class="ssp-onboarding ssp-onboarding-step-1">
	...
	<div class="ssp-onboarding__settings">
		<?php if ( $is_import ) : ?>
			<?php include __DIR__ . '/step-1-import.php'; ?>
		<?php else : ?>
			...
			<div class="ssp-onboarding__or">
				<span class="ssp-onboarding__or-line"></span>
				<span class="ssp-onboarding__or-text"><?php esc_html_e( 'or', 'seriously-simple-podcasting' ); ?></span>
				<span class="ssp-onboarding__or-line"></span>
			</div>

			<div class="ssp-onboarding__import-offer">
				<div class="ssp-onboarding__import-offer-text">
					<h2><?php esc_html_e( 'Already have a podcast somewhere else?', 'seriously-simple-podcasting' ); ?></h2>
					<p><?php esc_html_e( 'Bring your show and all its episodes over from Castos, Libsyn, Buzzsprout or any other host using its RSS feed.', 'seriously-simple-podcasting' ); ?></p>
				</div>
				<a class="button" href="<?php echo esc_url( $import_url ); ?>">
					<?php esc_html_e( 'Import a podcast', 'seriously-simple-podcasting' ); ?>
				</a>
			</div>
		<?php endif; ?>
	</div>
