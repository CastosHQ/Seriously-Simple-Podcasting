...
define( 'SSP_PLUGIN_URL', plugin_dir_url( SSP_PLUGIN_FIlE ) );
define( 'SSP_PLUGIN_PATH', plugin_dir_path( SSP_PLUGIN_FIlE ) );
...
$ssp_admin     = new Admin_Controller( SSP_PLUGIN_FIlE, SSP_VERSION );
$ss_podcasting = new Frontend_Controller( SSP_PLUGIN_FIlE, SSP_VERSION );
$ssp_players   = new Players_Controller();
...
if ( is_admin() ) {
	...
	$ssp_settings = new Settings_Controller( SSP_PLUGIN_FIlE, SSP_VERSION );
	$ssp_options  = new Options_Controller( SSP_PLUGIN_FIlE, SSP_VERSION );
}
/**
...
if ( version_compare( $wp_version, '5.0', '>=' ) ) {
	$ssp_castos_blocks = new Castos_Blocks( SSP_PLUGIN_FIlE, SSP_VERSION );
}
/**
...
if ( version_compare( $wp_version, '4.7', '>=' ) ) {
	...
	$ssp_wp_rest_api = new Rest_Api_Controller( SSP_PLUGIN_FIlE, SSP_VERSION );
}
