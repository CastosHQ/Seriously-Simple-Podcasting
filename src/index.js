		...
		return (
			<div className="podcast_player">
				<div className="ssp-player ssp-player-large" data-player-instance-number={1}
					 ...
					 data-source-file="https://wphackercast.com/podcast-player/1143/wp-hackercast-episode-24-tammie-lister-the-future-of-digital-experiences-and-all-things-esoteric.mp3"
					 id="ssp_player_id_1" style={{background: '#222222'}}>
					<div className="ssp-album-art-container">
						<div className="ssp-album-art" style={{
							background: 'url( https://wphackercast.com/wp-content/uploads/2017/11/WP-Hacker-Cast-300x300.png ) center center no-repeat',
							...
							<div className="ssp-player-info">
								<div style={{width: '80%', float: 'left'}}>
									<h3 className="ssp-player-title episode-title">
										WP HackerCast – Episode 24 – Tammie Lister – The Future of Digital Experiences
										and All
										Things Esoteric
									</h3>
								</div>
									...
									<div className="ssp-custom-player-controls">
										...
										<div className="ssp-time-volume">
											<div className="ssp-duration">
												...
												id="sspTotalDuration">00:59:37</span>
											</div>
												...
												<div className="ssp-download-container">
													<div className="ssp-download-control">
														<a className="ssp-episode-download"
														   href="https://wphackercast.com/podcast-download/1143/wp-hackercast-episode-24-tammie-lister-the-future-of-digital-experiences-and-all-things-esoteric.mp3?ref=download"
														   target="_blank"><i
															className="ssp-icon icon-cloud-download">&nbsp;</i></a>
													</div>
												</div>
											</div>
										</div>
