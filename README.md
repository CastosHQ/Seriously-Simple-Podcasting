...
[Seriously Simple Podcasting](http://www.castos.com/seriously-simple-podcasting) is a podcast plugin for WordPress that takes the complexity out of running your own podcast without sacrificing any powerful (and necessary) features. It is developed and maintained by Craig Hewitt and our team of great developers at Castos. If you would like to know more about the plugin you can follow [@CastosHQ](https://twitter.com/castoshq) .
...
If you enjoy using Seriously Simple Podcasting and find value in the plugin then please [leave a review](https://wordpress.org/support/view/plugin-reviews/seriously-simple-podcasting?rate=5#postform) to help promote continuing development.
