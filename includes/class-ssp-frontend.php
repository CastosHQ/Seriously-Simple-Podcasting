									...
									$('#ssp_player_id_<?php echo $large_player_instance_number; ?> #ssp_playback_speed<?php echo $large_player_instance_number; ?>').on('click', function (e) {
										switch ($(e.currentTarget).parent().find('[data-ssp-playback-rate]').attr('data-ssp-playback-rate')) {
											case "1":
												...
												$( e.currentTarget ).parent().find( '[data-ssp-playback-rate]' ).text('1.5X' ).attr('aria-label', 'Increase playback speed. Currently at 1.5x');
											...
											case "1.5":
												...
												$( e.currentTarget ).parent().find( '[data-ssp-playback-rate]' ).text('2X' ).attr('aria-label', 'Reset playback speed. Currently at 2x.');
											...
											case "2":
												...
												$( e.currentTarget ).parent().find( '[data-ssp-playback-rate]' ).text('1X' ).attr('aria-label', 'Increase playback speed. Currently at 1x.');
