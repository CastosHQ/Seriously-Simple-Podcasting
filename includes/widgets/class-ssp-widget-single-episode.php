...
class SSP_Widget_Single_Episode extends WP_Widget {
	...
	public function __construct() {
		...
		$this->widget_description = __( 'Display a single podcast episode.', 'ss-podcasting' );
		$this->widget_idbase = 'ss_podcast';
		$this->widget_title = __( 'Podcast: Single Episode', 'ss-podcasting' );
...
?>
		...
		<input class="widefat" id="<?php echo $this->get_field_id( 'title' ); ?>" name="<?php echo $this->get_field_name( 'title' ); ?>" type="text" placeholder="<?php _e( 'Use episode title', 'ss-podcasting' ); ?>" value="<?php echo $title; ?>" /></p>
		...
		<label for="<?php echo $this->get_field_id( 'show_title' ); ?>"><?php _e( 'Display episode title inside widget?', 'ss-podcasting' ); ?></label></p>
		...
		<label for="<?php echo $this->get_field_id( 'show_excerpt' ); ?>"><?php _e( 'Display episode excerpt?', 'ss-podcasting' ); ?></label></p>
		...
		<label for="<?php echo $this->get_field_id( 'show_content' ); ?>"><?php _e( 'Display full episode content?', 'ss-podcasting' ); ?></label></p>
		...
		<label for="<?php echo $this->get_field_id( 'show_player' ); ?>"><?php _e( 'Display episode audio player?', 'ss-podcasting' ); ?></label></p>
		...
		<label for="<?php echo $this->get_field_id( 'show_details' ); ?>"><?php _e( 'Display episode details?', 'ss-podcasting' ); ?></label></p>
<?php
	}
} // End Class
