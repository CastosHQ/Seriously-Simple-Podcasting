	...
	private function settings_fields() {
		...
		$settings['feed-details'] = array(
			...
			'fields'				=> array(
				...
				array(
					'id' 			=> 'data_category',
					'label'			=> __( 'First Category' , 'seriously-simple-podcasting' ),
					'description'	=> __( 'Your podcast\'s first category.', 'seriously-simple-podcasting' ),
					'type'			=> 'select',
				...
				array(
					'id' 			=> 'data_subcategory',
					'label'			=> __( 'First Sub-Category' , 'seriously-simple-podcasting' ),
					'description'	=> __( 'Your podcast\'s first sub-category (if available) - must be a sub-category of the first category selected above.', 'seriously-simple-podcasting' ),
					'type'			=> 'select',
				...
				array(
					'id' 			=> 'data_category2',
					'label'			=> __( 'Second Category' , 'seriously-simple-podcasting' ),
					'description'	=> __( 'Your podcast\'s second category.', 'seriously-simple-podcasting' ),
					'type'			=> 'select',
					'options'		=> $category_options,
					'default'		=> '',
					'callback'		=> 'wp_strip_all_tags',
				...
				array(
					...
					'label'			=> __( 'Second Sub-Category' , 'seriously-simple-podcasting' ),
					'description'	=> __( 'Your podcast\'s second sub-category (if available) - must be a sub-category of the second category selected above.', 'seriously-simple-podcasting' ),
					'type'			=> 'select',
					'options'		=> $subcategory_options,
					'default'		=> '',
					'callback'		=> 'wp_strip_all_tags',
				...
				array(
					'id' 			=> 'data_category3',
					'label'			=> __( 'Third Category' , 'seriously-simple-podcasting' ),
					'description'	=> __( 'Your podcast\'s third category.', 'seriously-simple-podcasting' ),
					'type'			=> 'select',
					'options'		=> $category_options,
					'default'		=> '',
					'callback'		=> 'wp_strip_all_tags',
				...
				array(
					...
					'label'			=> __( 'Third Sub-Category' , 'seriously-simple-podcasting' ),
					'description'	=> __( 'Your podcast\'s third sub-category (if available) - must be a sub-category of the third category selected above.', 'seriously-simple-podcasting' ),
					'type'			=> 'select',
					'options'		=> $subcategory_options,
					'default'		=> '',
					'callback'		=> 'wp_strip_all_tags',
