 ...
 * @since 3.13.1
 */
class SSPPodcastsBlockTest extends \Codeception\TestCase\WPTestCase
{
    /**
     * @var Castos_Blocks
     */
     ...
     */
    public function testSspPodcastsBlockRegistration()
    {
     ...
     */
    public function testSspPodcastsBlockAttributes()
    {
        // Trigger the init action to register blocks
        @do_action('init');
     ...
     */
    public function testSspPodcastsBlockRenderCallback()
    {
     ...
     */
    public function testSspPodcastsBlockRenderCallbackWithAttributes()
    {
        // Create test podcast series
     ...
     */
    public function testSspPodcastsBlockRenderCallbackWithColors()
    {
        // Create test podcast series
        $series = $this->factory()->term->create([
            'taxonomy' => 'series',
     ...
     */
    public function testSspPodcastsBlockRenderCallbackWithDescriptionTruncation()
    {
     ...
     */
    public function testSspPodcastsBlockEditorScript()
    {
        // Trigger the init action to register blocks
        @do_action('init');
     ...
     */
    public function testSspPodcastsBlockCssAssets()
    {
     ...
     */
    public function testSspPodcastsBlockRenderCallbackInvalidParameters()
    {
        // Trigger the init action to register blocks
        @do_action('init');
     ...
     */
    public function testSspPodcastsBlockRenderCallbackEmptyResults()
    {
        // Trigger the init action to register blocks
        @do_action('init');
