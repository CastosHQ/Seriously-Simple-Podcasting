	...
	render() {
		...
		const player = (
			<div className={this.props.className}>
				<h2 className="title">{this.props.episodeTitle}</h2>
				<img src={this.props.episodeImage} />
				<a href={this.props.episodeFileUrl}>Play</a>
				<span id="sspTotalDuration">{this.props.episodeDuration}</span>
				<a className="download" href={this.props.episodeDownloadUrl} target="_blank" rel="noopener noreferrer">Download</a>
			</div>
		);
		return player;
	}
