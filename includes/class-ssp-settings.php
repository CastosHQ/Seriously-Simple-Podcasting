		...
		$settings['feed-details'] = array(
			...
			'fields'      => array(
				...
				array(
					...
					'description' => sprintf(__( 'To mark this podcast as an explicit podcast, add a checkmark here. Explicit content rules can be found %s.', 'seriously-simple-podcasting' ), '<a href="https://discussions.apple.com/thread/1079151">here</a>'),
					'type'        => 'checkbox',
					'default'     => '',
					'callback'    => 'wp_strip_all_tags',
				),
