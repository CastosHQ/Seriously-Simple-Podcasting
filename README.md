...
![1. The plugin settings screen within the WordPress admin.](http://ps.w.org/seriously-simple-podcasting/assets/screenshot-1.png)

### 2. The info that you need to add to each podcast episode. ###
![2. The info that you need to add to each podcast episode.](http://ps.w.org/seriously-simple-podcasting/assets/screenshot-2.png)
