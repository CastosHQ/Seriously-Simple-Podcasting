			...
			<div class="player__body">
				...
				<div class="play-progress">
					<div class="play-pause-controls">
						<button title="
						<?php
						esc_attr_e( 'Play', 'seriously-simple-podcasting' )
						?>
						" aria-label="
						<?php
						...
						<button title="
						<?php
						esc_attr_e( 'Pause', 'seriously-simple-podcasting' )
						?>
						" aria-label="
						<?php
						...
						<img src="<?php echo SSP_PLUGIN_URL; ?>assets/css/images/player/images/icon-loader.svg" alt="
						<?php
						esc_attr_e( 'Loading', 'seriously-simple-podcasting' )
						?>
						" class="ssp-loader hide"/>
					</div>
					<div>
						<audio preload="none" class="clip clip-<?php esc_attr_e( $episode_id ); ?>">
							<source src="<?php echo $audio_file; ?>">
						</audio>
						<div class="ssp-progress" role="progressbar" title="
						<?php
						...
						" aria-valuemax="
						<?php
						echo ssp_duration_seconds( $duration )
						?>
						">
