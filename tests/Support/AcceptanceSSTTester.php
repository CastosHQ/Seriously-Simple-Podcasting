...
/**
 * AcceptanceSST Tester
 *
 * Custom Gherkin step definitions for acceptance tests that require Seriously Simple Transcripts plugin.
 *
 * @since 3.14.3
 *
 ...
 */
class AcceptanceSSTTester extends \Codeception\Actor
{
    use _generated\AcceptanceSSTTesterActions;
